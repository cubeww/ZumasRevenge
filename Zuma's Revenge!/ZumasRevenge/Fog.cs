...
public class Fog : Effect
{
	...
	{
		return SexyFramework.Common.IntRange(Common._M(150), Common._M1(500));
	}

	private static float GetSizeTimeRange()
	{
		return SexyFramework.Common.IntRange(Common._M(200), Common._M1(500));
	}
	...
	protected override void Init()
	{
		...
		mFogElements.Sort(new ImageSort());
	}
	...
	{
		if (g.Is3D() && !mForceAllDrawOverBalls)
		{
			DoDraw(g, under: true);
		}
	}
